...
export function WindowWrapper({
  ...
  return (
    <div
      ref={windowRef}
      className={`fixed bg-white dark:bg-gray-900 shadow-2xl dark:shadow-gray-950/50 transition-all flex flex-col ${
    ...
    >
      ...
      <div
        ref={headerRef}
        className="shrink-0 flex items-center gap-3 px-4 py-3 bg-gradient-to-b from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-900 border-b border-gray-200 dark:border-gray-700 select-none relative z-10"
      ...
      >
        ...
        {headerContent ? (
          ...
          <h2 className="absolute left-1/2 -translate-x-1/2 text-sm font-semibold text-gray-700 dark:text-gray-200 pointer-events-none">
            {title}
          </h2>
        )}
      </div>
